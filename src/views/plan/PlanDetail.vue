  ...
  <!-- <div class="row justify-content-center" style="margin-top: 100px">
    <div class="col-lg-8 col-md-10 col-sm-12">
      <h2 class="my-3 py-3 shadow-sm bg-light text-center">
        <mark class="sky">계획 상세보기</mark>
      </h2>
    </div>
    <div class="col-lg-8 col-md-10 col-sm-12">
      <div class="row my-2 justify-content-center align-items-center">
        <div class="col-md-8 d-flex justify-content-center">
          <h2 class="text-secondary mb-0" style="padding-right: 10px;">HEY</h2>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 text-center">
          ...
          <div class="clearfix align-content-center">
            <li v-for="attraction in attractions" :key="attraction.contentTypeId" class="page-item" :class="{ 'active': pgno === index }" :data-pg="index">
...
//           `http://localhost/api/plan/rest/planId/${this.id}`
//         );
//         this.plan = response.data;
//         this.attractions = this.plan.planAttractionDto.attractionList;
//         console.log(this.attractions[0]);
//       } catch (err) {
//         console.log("계획 목록 조회 오류: " + err);
//       }
//     },
//     async getInfoPost() {
//       try {
